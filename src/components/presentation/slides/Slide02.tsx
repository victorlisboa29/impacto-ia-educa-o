  ...
  return (
    <SlideLayout variant="light">
      <div className="px-20 pt-16 h-full">
        ...
        <h2 className="mt-4 text-[64px] font-extrabold leading-[1.05] text-slide-dark">
          Muitas possibilidades.<br />Pouca clareza de onde começar.
        </h2>

        {/* Cards */}
        <div className="flex gap-8 mt-12">
          <div className="flex-1 bg-white rounded-2xl p-8 shadow-lg shadow-black/5">
            <div className="flex items-center gap-4 mb-4">
              <Brain className="w-10 h-10 text-slide-primary-light" />
              <h3 className="text-[28px] font-bold text-slide-dark">IA generativa está em toda parte</h3>
            </div>
          ...
          <div className="flex-1 bg-white rounded-2xl p-8 shadow-lg shadow-black/5">
            <div className="flex items-center gap-4 mb-4">
              <Target className="w-10 h-10 text-slide-primary-light" />
              <h3 className="text-[28px] font-bold text-slide-dark">Falta foco estratégico</h3>
            </div>
            <p className="text-[22px] text-slide-text-muted leading-relaxed">
