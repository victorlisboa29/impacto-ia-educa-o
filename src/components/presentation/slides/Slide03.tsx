...
const pains = [
  ...
  { icon: Settings, title: "Operação sobrecarregada", desc: "Equipes fazendo tarefas repetitivas que poderiam ser automatizadas.", color: "bg-slide-magenta" },
];
    ...
    <SlideLayout variant="dark">
      <div className="px-20 pt-14 h-full">
        ...
        <div className="flex gap-6 mt-10">
          {pains.map((p, i) => (
            <div key={i} className="flex-1 bg-slide-mid rounded-xl overflow-hidden shadow-lg shadow-[hsl(270,80%,20%)]/30">
