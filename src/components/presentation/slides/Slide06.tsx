...
const steps = [
  ...
  { num: "03", title: "Medir\nResultado", desc: "Defina métricas claras antes de implementar", color: "text-slide-cyan", borderColor: "bg-slide-cyan", Icon: BarChart3 },
  ...
  return (
    <SlideLayout variant="light">
      <div className="px-16 pt-14 h-full">
        ...
        <h2 className="mt-3 text-[54px] font-extrabold text-slide-dark">4 etapas para gerar valor com IA</h2>

        <div className="flex items-start gap-4 mt-10">
          {steps.map((s, i) => (
            <div key={s.num} className="flex items-start gap-3 flex-1">
              <div className="bg-white rounded-2xl shadow-lg shadow-black/5 overflow-hidden flex-1">
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-[28px] font-bold text-slide-dark leading-tight whitespace-pre-line mb-4">
                    {s.title}
                  </h3>
